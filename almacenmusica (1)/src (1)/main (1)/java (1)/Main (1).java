...
public class Main{
    public static void main(String[] args) {
       ...
       //anade gran cantidad de inventario para surtir a las otras
        ...
        invmain.aniadirMp3(new MP3(codigo1,12000,"La yipsy","dibujos"));
        invmain.aniadirMp3(new MP3(codigo2,13000,"El perrito de la salsa","volumen 1"));
        invmain.aniadirMp3(new MP3(codigo3,14000,"xxtentation","?"));
        invmain.aniadirMp3(new MP3(codigo4,15000,"Henry stilo","twodirection"));
        ...
        System.out.println(invmain.toString());
        invsucursal1.aniadirMP3(new MP3(codigo1,12000,"La yipsy","dibujos"));
        System.out.println(invsucursal1.toString());
        invsucursal2.aniadirMP3(new MP3(codigo2,13000,"El perrito de la salsa","volumen 1"));
        System.out.println(invsucursal2.toString());
        invsucursal3.aniadirMP3(new MP3(codigo3,14000,"xxtentation","?"));
        System.out.println(invsucursal3.toString());
        invsucursal4.aniadirMP3(new MP3(codigo4,15000,"Henry stilo","twodirection"));
        System.out.println(invsucursal4);
